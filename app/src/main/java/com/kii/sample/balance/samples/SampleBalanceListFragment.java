...
import com.kii.sample.balance.list.ItemEditDialogFragment;
import com.kii.sample.balance.list.KiiObjectAdapter;
 ...
 */
public class SampleBalanceListFragment extends ListFragment {
    ...
    public static SampleBalanceListFragment newInstance() {
        return new SampleBalanceListFragment();
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case REQUEST_ADD: {
                String name = data.getStringExtra(SampleItemEditDialogFragment.RESULT_NAME);
                int type = data.getIntExtra(SampleItemEditDialogFragment.RESULT_TYPE, Field.Type.EXPENSE);
                int amount = data.getIntExtra(SampleItemEditDialogFragment.RESULT_AMOUNT, 0);
            ...
            case REQUEST_EDIT: {
                ...
                String objectId = data.getStringExtra(SampleItemEditDialogFragment.RESULT_OBJECT_ID);
                String name = data.getStringExtra(SampleItemEditDialogFragment.RESULT_NAME);
                int type = data.getIntExtra(SampleItemEditDialogFragment.RESULT_TYPE, Field.Type.EXPENSE);
                int amount = data.getIntExtra(SampleItemEditDialogFragment.RESULT_AMOUNT, 0);

                if (SampleItemEditDialogFragment.ACTION_UPDATE.equals(action)) {
