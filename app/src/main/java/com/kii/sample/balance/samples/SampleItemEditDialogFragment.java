...
public class SampleItemEditDialogFragment extends DialogFragment {
    ...
    public static SampleItemEditDialogFragment newInstance(Fragment target, int requestCode,
                                                           String objectId, String name, int type, int amount) {
        SampleItemEditDialogFragment fragment = new SampleItemEditDialogFragment();
